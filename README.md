...
Estimated sigma map is predicted by SDNet additionally trained on image patches distorted by Poisson noise and on image patches distorted by multiplicative Gaussian noises.  The pre-trained model is available on [pre-trained grayscale_poisson](https://webpages.tuni.fi/imaging/sdnet/sdnet_gray_poisson.mat)
